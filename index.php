...
<head>
    ...
    <title>Dashboard - Memorandum Of Understanding</title>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="small-box bg-secondary">
                            <div class="inner text-center">
                                ...
                                <h5 class="card-title mt-3">MoU</h5>
                                <p class="card-text">Data MoU</p>
                            </div>
                            <div class="icon">
                                <i class="fas fa-file-alt"></i>
                            </div>
                            <a href="memorandum_of_understanding.php?page=memorandum_of_understanding" class="small-box-footer">
                                Manage MoU <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                </div>
