...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT userid, username, password, fullname, status FROM db_perjanjian_kerja_sama.users WHERE username = ? OR fullname = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            $updateQuery = "UPDATE db_perjanjian_kerja_sama.users SET login_date = ?, tokenize = ? WHERE userid = ?";
